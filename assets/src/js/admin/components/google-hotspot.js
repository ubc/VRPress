                    ...
                    <>
                        ...
                        <tr>
                            ...
                            <td>
                                <input
                                    type="checkbox"
                                    checked={hotspot[hotspot.type] && 'yes' === hotspot[hotspot.type].newTab}
                                    name={`${name}[${hotspot.type}][newTab]`}
                                    value="yes"
                                    onChange={(e) => {
                                        setHotspotByType(hotspot.type)('newTab', 'yes' === hotspot[hotspot.type].newTab ? 'no' : 'yes');
                                    }}
                                >
                                </input>
