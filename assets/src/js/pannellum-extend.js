    ...
    window.ubcVRPressInit = function( viewer ) {
        ...
        let hotspotContentModal =
            `<div class="pnlm-container__hotspot-modal">
                ...
                <div class="pnlm-container__hotspot-modal-content"></div>
            </div>`;

        // Append  custom DOM render container.
        ...
        $( container ).find( '.pnlm-container__hotspot-modal button' ).on( 'click', function( e ) {
            e.preventDefault();
            $( this ).closest( '.pnlm-container__hotspot-modal' ).removeClass( 'show' ).find( '.pnlm-container__hotspot-modal-content' ).html( '' );
